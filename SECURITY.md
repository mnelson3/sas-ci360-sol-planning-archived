...
This repository holds a retained historical/archived Python client library for SAS Customer Intelligence 360's Planning APIs. It is no longer actively developed. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas-ci360-sol-planning-archived/security/advisories/new) (enabled on this repo), or
